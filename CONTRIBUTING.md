<h1 style="center">
 <img src="https://www.smudgy.store/uploads/icon.png" style="height: 1.4em">
...
- **Share your client version and platform details**
...
1. Clone your fork:
```bash
git clone https://github.com/OBS-Akuma/smudgy-client.git
cd smudgy-client
npm install
npm run build
```
